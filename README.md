...
- Notion과 Chatgpt의 크롬 프로필이 달라도 두 프로필 모두 확장프로그램 설치 후 동일 Integration Token 주입 시 정상 작동합니다.
...
5. 답변의 길이에따라 10초 이상 걸릴 수 있습니다.

## 버튼 켜기/끄기

확장 프로그램을 삭제하지 않아도 팝업에서 다음 기능을 각각 켜고 끌 수 있습니다.

- `ChatGPT 복사 버튼`
  ChatGPT 답변 옆의 `Copy for Notion` 버튼 표시 여부
- `Notion 붙여넣기 기능`
  Notion의 `Paste ChatGPT` 버튼과 붙여넣기 가로채기 동작 여부
